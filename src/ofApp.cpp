...
void ofApp::update()
{
	...
	if (m_bSetup) {
		...
		tilt = ofMap(m_controllerRot.y,0.0f,20.0f,-90.0f,90.0f);
		pan = ofMap(m_controllerRot.x, 0.0f, 20.0f, -90.0f, 90.0f);
		ofVec3f orient(pan, -tilt, 0.0f);
	...
	m_acceleration /= 1.05f * (m_brake_val / 20.0f);
}
//--------------------------------------------------------------
void ofApp::draw()
{
